                                ...
                                <div class="chat-section">
                                    ...
                                    <div class="record_btns">
                                        <table class="recording_btn" style="display: none;">
                                                    <tr>
                                                        <td><button id="pauseButton" disabled>Pause</button></td>
                                                        <td><button id="stopButton" disabled>Stop</button></td>
                                                    </tr>
                                                </table>
                                    </div>
                                        <div class="chat-box">
                                        ...
                                        <div class="chat-input-toolbar">
                                            <input type='file' "btn-file-upload tool-items" id='inputfileupload' style='width: 65%;float: left;margin: 10px;'/>
